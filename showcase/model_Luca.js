!(function (exports){
	...
	var scalaPunti = function(pointList, scalamento) {
      return pointList.map( function(pt) { 
	...
	// scala punti controlli
	puntiAsseXZ = puntiAsseXZ.map(function(ptlist) {return scalaPunti(ptlist,scalaRot);});
	AA(HER0)(puntiAsseXZ);
	...
	// Sfera sopra
	var sphereTop = T([2])([(6.55+0.5)*scalaRot])(S([0,1,2])([scalaRot,scalaRot,scalaRot])(sphereSurface(1)));
