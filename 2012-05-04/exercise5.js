...
var pistaAereo = function() {
	var mantello = COLOR([0.3,0.3,0.3])( T([0,1])([-15,-45])( CUBOID([30,90,0.1]) ) );
	var rigaContinua = COLOR([0.9,0.9,0.9])( T([0,1,2])([-0.5,-45,0.1])( CUBOID([1,90,0.01]) ) );
	var rigaContinuaSin = COLOR([220/255,20/255,60/255])( T([0])([-14.5])(rigaContinua) );
	var rigaContinuaDes = COLOR([220/255,20/255,60/255])( T([0])([14.5])(rigaContinua) );
	var erbaIntorno = COLOR([0/255, 100/255, 0/255])( T([0,1,2])([-20,-50,-0.2])( CUBOID([40,100,0.1]) ) );
	var pista = STRUCT([mantello,rigaContinua,rigaContinuaSin,rigaContinuaDes,erbaIntorno]);
	return pista;
}

DRAW( STRUCT([
	pistaAereo() ,
	T([2])([3])(R([1,2])(PI/2)(drawAereo()))
]) );