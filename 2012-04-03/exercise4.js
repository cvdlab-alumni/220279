...
var mioModello = function() {
	var schiena = SIMPLEX_GRID([[0.7],[0.05],[1]]);
	var sedere = SIMPLEX_GRID([[0.7],[-0.05,0.2],[-0.4,0.1]]);
	var gambeAvanti = SIMPLEX_GRID([[0.7],[-0.25,0.1],[0.5]]);

	return COLOR([139/255,0/255,0,255])(STRUCT([schiena,sedere,gambeAvanti]));
};
