jush.api.js = {
	...
	/* PLASM extension */
	'BEZIER': 'Transfinite mapping function of genric degree Bezier curve.',
	'BOUNDARY': 'Get the d-boundary of the model.',
	'CANCEL': 'Remove the object from the scene graph.',
	'CIRCLE': 'Create a circle with radius r, approximated by divs segments.',
	'CYLINDRICAL_SURFACE': 'Create a specific ruled surface S called cylindrical where the direction of the lines is given by the vector with constant components that is non complanar with the section curve (profile). The profile curve can be a known profile function, like BEZIER, or a custom one.',
	'COLOR': 'Clone object and color cloned object with color.',
	'CONICAL_SURFACE': 'Create a conical surface S between a vertex (apex) and a profile curve. The curve can be a known profile function, like BEZIER, or a custom one.',
	'COONS_PATCH': 'Mapping function of a Coons Patch.',
	'COS': 'Returns the cosine of a number (x)',
	'CUBE': 'Create a dim-dimensional cube.',
	'CUBIC_CARDINAL': 'Tranfinite Cubic cardinal splines curve generator function on domain.',
	'CUBIC_HERMITE': 'Transfinite mapping function of cubic Hermite curve.',
	'CUBIC_UBSPLINE': 'Tranfinite cubic uniform B-splines curve generator function on domain.',
	'CUBOID': 'Create a cuboidal simplicial complex with dimensions [dx, dy, dz, ...].',
	'CYL_SURFACE': 'Create a cylindrical surface.',
	'DISK': 'Create a disk surface with radius r.',
	'DOMAIN': 'Create a domain.',
	'DRAW': 'Draw an object of 3 or less dimensions.',
	'EXPLODE': 'Explode a model.',
	'EXTRUDE': 'Extrude an object.',
	'HIDE': 'Hide the object.',
	'INTERVALS': 'Create a segment from 0 to length divided in n parts.',
	'MAP': 'Map a domain by a mapping function.',
	'NUBSLINE': 'Non-uniform B-Spline.',
	'NUBS': 'Transfinite Non-uniform B-Spline.',
	'NURBSLINE': 'Non-uniform Rational B-Spline.',
	'PI': 'Constant PI',
	'POLYLINE': 'Create a polyline made by points.',
	'POLYPOINT': 'Create a 0D complex.',
	'PROD1x1': 'Return cartesian product of the two models in array. Each model must have Rn equals to 1.',
	'PROD1x2': 'Return cartesian product of the two models in array. The first model must have Rn equals to 1. The second model must have Rn equals to 2. ',
	'PROD2x1': 'Return cartesian product of the two models in array. The first model must have Rn equals to 2. The second model must have Rn equals to 1. ',
	'PROFILEPROD_SURFACE': 'Create a surface S mapping as profile product between two plane curves A and B (in profiles)',
	'R': 'Rotate object by angle on the rotational plane described by dims.',
	'ROTATE': 'Rotate object by angle on the rotational plane described by dims.',
	'ROTATIONAL_SURFACE': 'Create a rotational surface mapping given the mapping of the profile to rotate.',
	'RULED_SURFACE': 'Create a ruled surface S mapping between two profile curves A and B (in profiles). The curves can either be a known profile function, like BEZIER, or a custom one (see examples).',
	'S': 'Scale model by values along axis.',
	'SCALE': 'Scale model by values along axis.',
	'SHOW': 'Show a hidden object.',
	'SIMPLEX': 'Create a dim-dimensional simplex with sides length equal to 1.',
	'SIMPLEX_GRID': 'Create a grid simplicial complex.',
	'SIMPLICIAL_COMPLEX': 'Create a simplicial complex.',
	'SIN': 'Returns the sine of a number (x)',
	'SKELETON': 'Extract the dim-skeleton of the model.',
	'SPLINE': 'Create spline curve.',
	'STRUCT': 'Structure together plasm.Model and plasm.Struct. If a transformation is encountered in items, it is applied to all of the following items.',
	'T' : 'Clone model and translate cloned model by values on dimensions dims.',
	'TORUS_SOLID': 'Create a torus solid.',
	'TORUS_SURFACE': 'Create a toroidal surface.',
	'TRANSLATE': 'Clone model and translate cloned model by values on dimensions dims.',
	'TRIANGULAR_COONS_PATCH': 'Create a triangular Coons patch interpolating three control curves',
	'TRIANGLE_DOMAIN': 'Create a triangle domain using three points as vertices. Every edge is subdivided in n parts.',
	'TRIANGLE_FAN': 'Create a tiangle fan: first point is the center of the fan, center point is used with next two points to form a triangle. Every successive point is used with center point and the previuos point to form a triangle.',
	'TRIANGLE_STRIP': 'Create a tiangle strip: first three points made a triangle, every other point is used with next two points to form a triangle.'
};
